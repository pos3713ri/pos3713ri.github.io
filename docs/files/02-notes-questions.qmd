...
- 68% of the public supports marriage equality in the U.S. [[poll](https://gssdataexplorer.norc.org/trends/Gender%20&%20Marriage?measure=marhomo)]
...
4. Consider the concept of war. Come up with two examples each of normative, descriptive, and causal questions about war. Posit an answer to these questions as a claim.
5. Using the logic of the counterfactual that we discussed in class, explain why we cannot observe whether the two causal claims from question 4 are true or false.
