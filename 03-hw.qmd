...
Read chs. 1 and 2 of FPP (the textbook; see [here](https://www.dropbox.com/scl/fi/ulz39wi8k4pk0ox6m8yme/Freedman-Pisani-and-Purves-2007.pdf?rlkey=ktnom50ppagcj7640jpfee5xa&dl=0)) and do the assigned review exercises [here](fpp-exercises.pdf). 
...
1. If you want to print this PDF of assigned exercises to use later, that's a great idea. It's unlikely to change during the semester.



## R

Read and review your notes, [my notes](files/03-notes-dfs.html), and [my slides](files/03-slides-dfs.pdf) (I just discussed these ideas verbally without slides) over the basics of loading data into R. Answer the review questions **throughout** the document. Remember to practice!
