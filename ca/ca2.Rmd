...
1. In the script, do the following (include comments!):
   ...
   a. Create three scatterplots, one for each predictor (% change in RDI, % change in GDP, and unemployment rate). In each scatterplot, put the incumbent margin of victory along the y-axis and the predictor along the x-axis. Add a regression line.
