...
![](diagrams/speculation-observation.png)
...
- Find a "critical experiment" or "critical test". The ideal approach is to compare alternative models. When we have two competing models, we’d like to find a situation in which the two model produce different implications. This is a powerful situation, because only one of the models can be correct.
...
1. In some countries, policy responds quickly to shifts in public opinion. In other countries, policy changes much more slowly. Why? Develop a model to explain responsiveness.
1. Turnout varies substantially across countries. On average, turnout is about 48% in the U.S., 83% in Brazil, 87% in Denmark, and 93% in Chile. Many researchers believe that low turnout is a problem for a democracy and would like to see higher turnout in the US. 
